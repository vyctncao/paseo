...
export const ar: TranslationResources = {
  ...
  pet: {
    ...
    activity: {
      status: {
        needsInput: "يحتاج إليك",
        blocked: "متوقف",
        ready: "جاهز",
        running: "قيد التشغيل",
      },
      summaryNone: "لا توجد محادثات نشطة",
      summaryOne: "محادثة نشطة واحدة",
      summaryMany: "{{count}} محادثات نشطة",
      title: "المحادثات النشطة",
      empty: "كل المحادثات هادئة",
  ...
  settings: {
    ...
    pets: {
      selected: "محدّد",
      select: "اختيار",
      currentlyShown: "المعروض حاليًا",
      selectAccessibility: "اختيار {{name}}",
      refresh: "تحديث",
      refreshAccessibility: "تحديث الحيوانات الأليفة",
      addCustom: "إضافة مخصص",
      addCustomAccessibility: "إضافة حيوان أليف مخصص",
      addCustomErrorTitle: "تعذّرت إضافة الحيوان الأليف",
      addCustomErrorMessage: "تحقق من مجلد الحيوان الأليف وحاول مرة أخرى.",
      noHost: "اتصل بمضيف لاختيار حيوان أليف.",
      unavailableTransport: "اختيار الحيوان الأليف غير متاح لاتصال المضيف هذا.",
      loading: "جارٍ تحميل الحيوانات الأليفة...",
      unavailable: "تعذّر تحميل الحيوانات الأليفة من هذا المضيف.",
      empty: "لا توجد حيوانات أليفة مثبّتة على هذا المضيف.",
      description: "اختر الرفيق الذي يبقى على الشاشة ويطلعك على المحادثات النشطة.",
      unavailableSelection: "{{selected}} غير متاح هنا، لذا يتم عرض {{current}} بدلًا منه.",
      choose: "اختيار حيوان أليف",
      appearance: "المظهر",
      sizeLabel: "حجم الحيوان الأليف",
      sizeDescription: "اضبط حجم الحيوان الأليف على الشاشة",
      sizeValue: "{{size}} بكسل",
      sizeAccessibility: "حجم الحيوان الأليف: {{size}} بكسل",
    },
    general: {
      title: "عام",
      defaultSend: {
