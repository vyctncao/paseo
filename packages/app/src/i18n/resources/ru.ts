...
export const ru: TranslationResources = {
  ...
  newWorkspace: {
    ...
    create: "Создавать",
    projectPicker: {
      noProject: "Не работать в проекте",
    },
    isolation: {
      local: "Локально",
  ...
  pet: {
    ...
    activity: {
      status: {
        needsInput: "Нужен ваш ответ",
        blocked: "Заблокирован",
        ready: "Готов",
        running: "Работает",
      },
      summaryNone: "Нет активных чатов",
      summaryOne: "1 активный чат",
      summaryMany: "{{count}} активных чатов",
      title: "Активные чаты",
      empty: "Все чаты сейчас спокойны",
  ...
  settings: {
    ...
    pets: {
      selected: "Выбран",
      select: "Выбрать",
      currentlyShown: "Сейчас на экране",
      selectAccessibility: "Выбрать {{name}}",
      refresh: "Обновить",
      refreshAccessibility: "Обновить питомцев",
      addCustom: "Добавить своего",
      addCustomAccessibility: "Добавить собственного питомца",
      addCustomErrorTitle: "Не удалось добавить питомца",
      addCustomErrorMessage: "Проверьте папку питомца и повторите попытку.",
      noHost: "Подключитесь к хосту, чтобы выбрать питомца.",
      unavailableTransport: "Выбор питомца недоступен для этого подключения к хосту.",
      loading: "Загрузка питомцев...",
      unavailable: "Не удалось загрузить питомцев с этого хоста.",
      empty: "На этом хосте не установлены питомцы.",
      description: "Выберите спутника, который остаётся на экране и сообщает об активных чатах.",
      unavailableSelection:
        "{{selected}} здесь недоступен, поэтому вместо него отображается {{current}}.",
      choose: "Выбрать питомца",
      appearance: "Внешний вид",
      sizeLabel: "Размер питомца",
      sizeDescription: "Настройте размер питомца на экране",
      sizeValue: "{{size}} пикс.",
      sizeAccessibility: "Размер питомца: {{size}} пикселей",
    },
    general: {
      title: "Общий",
      defaultSend: {
