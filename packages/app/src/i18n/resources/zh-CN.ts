...
export const zhCN: TranslationResources = {
  ...
  pet: {
    ...
    activity: {
      ...
      summaryNone: "当前没有活跃聊天",
      summaryOne: "1 个活跃聊天",
      summaryMany: "{{count}} 个活跃聊天",
      title: "活跃聊天",
      empty: "所有聊天都很安静",
      untitled: "未命名聊天",
    },
  ...
  settings: {
    ...
    pets: {
      ...
      select: "选择",
      currentlyShown: "当前显示",
      selectAccessibility: "选择{{name}}",
      refresh: "刷新",
      refreshAccessibility: "刷新宠物",
      addCustom: "添加自定义宠物",
      addCustomAccessibility: "添加自定义宠物",
      addCustomErrorTitle: "无法添加宠物",
      addCustomErrorMessage: "请检查宠物文件夹后重试。",
      noHost: "连接到主机后即可选择宠物。",
      unavailableTransport: "此主机连接不支持选择宠物。",
      loading: "正在加载宠物...",
      unavailable: "无法从此主机加载宠物。",
      empty: "此主机上未安装宠物。",
      description: "选择一个常驻屏幕、随时告诉你活跃聊天状态的伙伴。",
      unavailableSelection: "{{selected}} 在这里不可用，因此当前显示 {{current}}。",
      choose: "选择宠物",
      appearance: "外观",
      sizeLabel: "宠物大小",
      sizeDescription: "调整屏幕上宠物的大小",
      sizeValue: "{{size}} px",
      sizeAccessibility: "宠物大小：{{size}} 像素",
    },
    general: {
      title: "通用",
      defaultSend: {
