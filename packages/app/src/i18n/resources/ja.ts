...
export const ja: TranslationResources = {
  ...
  pet: {
    ...
    activity: {
      status: {
        needsInput: "あなたの対応が必要",
        blocked: "ブロック中",
        ready: "準備完了",
        running: "実行中",
      },
      summaryNone: "アクティブなチャットはありません",
      summaryOne: "アクティブなチャット 1 件",
      summaryMany: "アクティブなチャット {{count}} 件",
      title: "アクティブなチャット",
      empty: "すべてのチャットが静かです",
      untitled: "無題のチャット",
    },
  ...
  settings: {
    ...
    pets: {
      selected: "選択中",
      select: "選択",
      currentlyShown: "現在表示中",
      selectAccessibility: "{{name}}を選択",
      refresh: "更新",
      refreshAccessibility: "ペットを更新",
      addCustom: "カスタムを追加",
      addCustomAccessibility: "カスタムペットを追加",
      addCustomErrorTitle: "ペットを追加できませんでした",
      addCustomErrorMessage: "ペットのフォルダを確認して、もう一度お試しください。",
      noHost: "ペットを選ぶにはホストに接続してください。",
      unavailableTransport: "このホスト接続ではペットを選択できません。",
      loading: "ペットを読み込んでいます...",
      unavailable: "このホストからペットを読み込めませんでした。",
      empty: "このホストにはペットがインストールされていません。",
      description: "画面に常駐し、アクティブなチャットの状況を知らせるペットを選びます。",
      unavailableSelection:
        "{{selected}}はここでは利用できないため、代わりに{{current}}を表示しています。",
      choose: "ペットを選ぶ",
      appearance: "外観",
      sizeLabel: "ペットのサイズ",
      sizeDescription: "画面上のペットのサイズを調整します",
      sizeValue: "{{size}} px",
      sizeAccessibility: "ペットのサイズ：{{size}}ピクセル",
    },
    general: {
      title: "一般",
      defaultSend: {
